...
function pageContentCarpools() {
  _jquery2.default.getJSON("http://apis.is/rides/samferda-drivers/").then(function (serverRes) {
    var carpoolRes = serverRes.results;
...
function pageContentFlights() {
  ...
  _jquery2.default.getJSON("http://apis.is/flight?language=en&type=arrivals").then(function (serverRes) {
    var flightRes = serverRes.results;
...
for (var i = 0; i < divAllNavbarItems.length; i++) {
  var currentNavbarItem = divAllNavbarItems[i];
  currentNavbarItem.addEventListener("click", function (evt) {
    var clickedItem = evt.currentTarget;
    var arrayOfClasses = [].concat(_toConsumableArray(clickedItem.classList));
    clearAllNavbarItems();
